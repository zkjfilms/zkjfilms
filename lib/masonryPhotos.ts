...
export const CREATIVE_PORTRAITS_MASONRY_PHOTOS: MasonryPhoto[] = [
  {
    key: "creative-portraits/anon-056401.jpg",
    width: 3725,
    height: 4656,
    alt: "Woman with tousled dark hair looking down, seated on a stone ledge in a white off-shoulder dress, dangling a black hat from one hand over a wooded creek backdrop.",
    src: publicImageUrl("creative-portraits/anon-056401.jpg"),
  },
  {
    key: "creative-portraits/anon-056041.jpg",
    width: 5642,
    height: 3761,
    alt: "Woman in a cream smocked-bodice blouse lying in grass, head tilted toward camera, one hand raised near her hair, the other resting on a dark hat beside her, warm low-angled light on her face.",
    src: publicImageUrl("creative-portraits/anon-056041.jpg"),
  },
  {
    key: "creative-portraits/anon-058881.jpg",
    width: 3771,
    height: 5657,
    alt: "Black-and-white portrait of a woman with a septum ring and feather earring, one arm raised above her head, dark hair swept across her bare shoulder, wearing a black slip dress with delicate arm bracelets, standing outdoors against a blurred tree line.",
    src: publicImageUrl("creative-portraits/anon-058881.jpg"),
  },
  {
    key: "creative-portraits/dsc-0536-4.jpg",
    width: 6048,
    height: 4024,
    alt: "Black-and-white low-angle portrait of a woman with long striped braids and a spiky feathered collar, chin tilted up, half her face lit and half in shadow beside a stone wall.",
    src: publicImageUrl("creative-portraits/dsc-0536-4.jpg"),
  },
  {
    key: "creative-portraits/traci-157.jpg",
    width: 4024,
    height: 6048,
    alt: "Black-and-white studio portrait of a woman with a loose top-knot and dangling round earrings, eyes closed and smiling as she clutches layers of black tulle ruffles at her chest, the full gown cascading into a long train on the floor.",
    src: publicImageUrl("creative-portraits/traci-157.jpg"),
  },
  {
    key: "creative-portraits/anon-058591.jpg",
    width: 4369,
    height: 2731,
    alt: "Woman with a small nose ring and beauty mark tilts her chin down, gazing through a gap in blurred green foliage, wearing a thin dark strap top.",
    src: publicImageUrl("creative-portraits/anon-058591.jpg"),
  },
  {
    key: "creative-portraits/anon-057561.jpg",
    width: 3594,
    height: 4492,
    alt: "Woman in an off-shoulder white top rests one raised hand on tree bark, head tilted back and eyes glancing sideways in warm golden backlight filtering through leaves.",
    src: publicImageUrl("creative-portraits/anon-057561.jpg"),
  },
  {
    key: "creative-portraits/anon-058691.jpg",
    width: 6240,
    height: 3510,
    alt: "Silhouetted against a pale dusk sky, a long-haired woman in a sleeveless dress and knee-high boots tilts her head back with both arms raised, fingers curled skyward, framed by dark treelines in an open field.",
    src: publicImageUrl("creative-portraits/anon-058691.jpg"),
  },
  {
    key: "creative-portraits/anon-058841.jpg",
    width: 5706,
    height: 3210,
    alt: "Side-profile silhouette of a woman in a black spaghetti-strap dress tilting her head back, one arm stretched skyward with hand curled, dark hair blown sideways across her face, low-angle shot against a hazy monochrome sky.",
    src: publicImageUrl("creative-portraits/anon-058841.jpg"),
  },
  {
    key: "creative-portraits/dsc-0557.jpg",
    width: 5081,
    height: 3381,
    alt: "Female vocalist with black-to-blonde dreadlocks and dark lipstick rests one hand on her waist, wearing a black feathered collar and leather corset belt, four tattooed bandmates in black band tees blurred behind her on a stone building's steps at golden hour.",
    src: publicImageUrl("creative-portraits/dsc-0557.jpg"),
  },
  {
